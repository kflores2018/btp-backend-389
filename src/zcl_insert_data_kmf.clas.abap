...
CLASS zcl_insert_data_kmf IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    "Creación de variables tipo tablas
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ_kf,
          lt_catego    TYPE TABLE OF ztb_catego_kf,
          lt_clientes  TYPE TABLE OF ztb_clientes_kf,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_kf,
          lt_libros    TYPE TABLE OF ztb_libros_kf.
    ...
    DELETE FROM ztb_acc_categ_kf.

    "Inserción de nuevos datos
    INSERT ztb_acc_categ_kf FROM TABLE @lt_acc_categ.
    ...
    DELETE FROM ztb_catego_kf.

    "Insertar nuevos datos
    INSERT ztb_catego_kf FROM TABLE @lt_catego.
    ...
    "Insertar nuevos datos
    INSERT ztb_clientes_kf FROM TABLE @lt_clientes.
    ...
    "Eliminar datos existentes
    DELETE FROM ztb_clnts_lib_kf.

    "Insertar nuevos datos
    INSERT ztb_clnts_lib_kf FROM TABLE @lt_clnts_lib.

    IF ( sy-subrc EQ 0 ).
      out->write( |Libros - Clientes: { sy-dbcnt } registros insertados| ).
    ENDIF.
    ...
    "Eliminar datos existentes
    DELETE FROM ztb_libros_kf.

    "Insertar nuevos datos
    INSERT ztb_libros_kf FROM TABLE @lt_libros.
